...
router.register(r"booking_page", views.Reservation_requestView, "booking_page")
...
urlpatterns = [
    ...
    # path("todos", TodoView.as_view(), name="todo"),
    # path("booking_page", Reservation_requestView.as_view(), name="booking_page"),
